...
class GLPlotWidget(QtOpenGL.QGLWidget):
    # default window size
    ...
    def paintGL(self):
        ...
        # set purple color for subsequent drawing rendering calls
        gl.glColor(1,0,1)
        # bind the VBO
        self.vbo.bind()
...
if __name__ == '__main__':
    ...
    class TestWindow(QtWidgets.QMainWindow):
        def __init__(self):
            ...
            self.data = np.array(x,ndmin=2)#np.array(.2*rdn.randn(100000,2),dtype=np.float32)
